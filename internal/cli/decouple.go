...
var decoupleCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return generator.DecoupleModule(moduleName, modPath, output, decouplePort, decoupleTransport)
	},
}
...
func init() {
	...
	decoupleCmd.Flags().StringVar(&decoupleTransport, "transport", "http", "Client scaffold transport: http or grpc")
